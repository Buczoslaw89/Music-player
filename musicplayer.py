...
root = Tk()
root.title("Buczer music player")
...
Button(root, text="Open folder", width=15, height=2, font=("consolas", 10, "bold"),
       fg="white", bg="#21b3de", command=open_folder).place(x=330, y=300)

scroll = Scrollbar(music_frame)
playlist = Listbox(music_frame, width=100, font=("consolas", 10), bg="#333333", fg="grey", selectbackground="lightblue",
